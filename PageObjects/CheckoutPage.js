...
class CheckoutPage{
    ...
    constructor(page)
    {
        ...
        this.AddDisplayed = page.locator("(//*[@id='address-list']//span[@class='break-word'])[2]")
...
async ShippingAddressVerification(address,city,zipcode)
{
    ...
    await expect(this.AddDisplayed).toContainText(city.toUpperCase())
    await expect(this.AddDisplayed).toContainText(zipcode.toUpperCase())
